      ...
      {isOpen &&
        createPortal(
          <div className="fixed inset-0 z-9999 flex items-center justify-center p-4 sm:p-6 md:p-10">
            {/* Backdrop matching colorBack #0e0d16 */}
            <div
              onClick={() => setIsOpen(false)}
              className="absolute inset-0 bg-[#0e0d16]/85 backdrop-blur-md transition-opacity animate-in fade-in duration-200"
            />

            {/* Large Modal Container */}
            <div
              className="relative w-full max-w-4xl h-[85vh] flex flex-col rounded-2xl shadow-2xl z-10 animate-in fade-in zoom-in-95 duration-200 border overflow-hidden"
              style={{
            ...
            >
              {/* Header Bar */}
              <div className="flex items-center justify-between px-6 py-4 border-b border-[#3e6274]/20 bg-[#0e0d16]/50">
                <div className="flex items-center gap-3">
                  <div className="w-2.5 h-2.5 rounded-full bg-[#3e6274]" />
                ...
                <div className="flex items-center gap-3">
                  ...
                  <a
                    ...
                    className="text-xs font-medium px-3.5 py-1.5 rounded-lg text-white transition-all cursor-pointer flex items-center gap-1.5 shadow-md active:scale-95"
                    style={{
                  ...
                  <button
                    onClick={() => setIsOpen(false)}
                    className="text-slate-400 hover:text-slate-100 p-1.5 rounded-full transition-colors cursor-pointer"
              ...
              <div className="flex-1 w-full bg-[#0e0d16] p-2 sm:p-4 overflow-hidden">
                <iframe
